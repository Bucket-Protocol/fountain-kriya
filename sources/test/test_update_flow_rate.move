#[test_only]
module kriya_fountain::test_update_flow_rate {
    ...
    fun test_update_flow_rate() {
        ...
        let second_stakers = ftu::stake_randomly<TEST_COIN_A, TEST_COIN_B, SUI>(scenario, second_staker_count);
    ...
    fun test_update_with_wrong_admin_cap() {
        ...
        let scenario = &mut scenario_val;
        let _ = ftu::stake_randomly<TEST_COIN_A, TEST_COIN_B, SUI>(scenario, 3);
